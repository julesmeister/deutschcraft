        ...
        <div className="mb-8 md:mb-16">
          <div className="bg-piku-yellow-light p-4 sm:p-6 md:p-8 lg:p-12 rounded-2xl md:rounded-3xl">
            ...
            <div className="mb-6 md:mb-8">
              <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-3 md:mb-4" style={{ lineHeight: '1.25em' }}>
                Build Your Custom Course 🎯
              </h3>
              <p className="text-base md:text-lg text-gray-700" style={{ lineHeight: '1.6em' }}>
            ...
            >
              <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-4 md:mb-6">
                <div>
                  <div className="text-xs sm:text-sm font-semibold text-gray-600 mb-1">Your Course</div>
                  <div className="text-2xl sm:text-3xl font-black text-gray-900 mb-2">
                    {levelInfo.displayName}
                  </div>
                  <div className="text-sm sm:text-base text-gray-600 mb-3 md:mb-4">{levelData.description}</div>
                  ...
                  <div className="space-y-1.5 sm:space-y-2">
                    ...
                    >
                      ...
                      <span className="text-sm sm:text-base font-semibold">{courseCalc.totalFlashcards} flashcards</span>
                    </motion.div>
                    <motion.div
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
                    ...
                    >
                      ...
                      <span className="text-sm sm:text-base font-semibold">{courseCalc.totalStudyHours} total study hours</span>
                    </motion.div>
                    <motion.div
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
                    ...
                    >
                      <span className="text-xl sm:text-2xl">📅</span>
                      <span className="text-sm sm:text-base font-semibold">{courseCalc.durationDisplay} at {hoursPerDay} hr{hoursPerDay !== 1 ? 's' : ''}/day</span>
                    </motion.div>
                  </div>
                </div>

                <div className="flex flex-col justify-center">
                  <div className="text-xs sm:text-sm font-semibold text-gray-600 mb-2">Course Price</div>
                  <motion.div
                  ...
                  >
                    <span className="text-3xl sm:text-4xl md:text-5xl font-black text-piku-purple">₱{courseCalc.price.toLocaleString()}</span>
                    <span className="text-base sm:text-lg md:text-xl text-gray-600">one-time</span>
                  </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
              {[
                ...
                <StaggerItem key={i} variant="slideUp">
                  <div className={`bg-white p-4 sm:p-6 md:p-8 rounded-xl md:rounded-2xl border-2 sm:border-4 ${plan.color} transition-all hover:-translate-y-2 hover:shadow-xl h-full`}>
