          ...
          <div className="space-y-2">
            {quizzes.map((quiz) => (
              <div
                ...
                role="button"
                tabIndex={0}
                className="w-full flex items-center justify-between p-4 bg-[#FFFBFE] rounded-[16px] hover:bg-[#F6EDFF] active:scale-[0.99] transition-all text-left group cursor-pointer"
