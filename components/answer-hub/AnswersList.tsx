      ...
      <div>
        ...
        <div className="space-y-3">
          {answers.map((answer, index) => (
            <div
              key={index}
              className={`bg-gray-50 border border-gray-200 p-4 ${!canSave ? 'opacity-70' : ''}`}
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(answer.itemNumber, e.target.value)}
                    disabled={!canSave}
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    {canSave ? (
                      savingStates[answer.itemNumber] ? (
