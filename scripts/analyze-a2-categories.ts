...
const A2_DIR = path.join(process.cwd(), 'lib', 'data', 'vocabulary', 'split', 'a2');
...
console.log('📊 A2 Category Analysis\n');
...
console.log(`   Total A2 cards: ${categories.reduce((sum, c) => sum + c.count, 0)}`);
