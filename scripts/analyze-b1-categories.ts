...
const B1_DIR = path.join(process.cwd(), 'lib', 'data', 'vocabulary', 'split', 'b1');
...
console.log('📊 B1 Category Analysis\n');
...
console.log(`   Total B1 cards: ${categories.reduce((sum, c) => sum + c.count, 0)}`);
