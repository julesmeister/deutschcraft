...
function rowToExerciseOverride(row: any): ExerciseOverride {
  return {
    ...
    exerciseData: row.exercise_data
      ? JSON.parse(row.exercise_data as string)
      : undefined,
    modifications: row.modifications
      ? JSON.parse(row.modifications as string)
      : undefined,
...
export async function createExerciseOverride(
  ...
  try {
    ...
    console.error(
      "[exerciseOverrideService:turso] Error creating override:",
      error
    );
    throw error;
  }
...
export async function getExerciseOverride(
  ...
  try {
    ...
    console.error(
      "[exerciseOverrideService:turso] Error fetching override:",
      error
    );
    throw error;
  }
...
export async function getTeacherOverrides(
  ...
  try {
    ...
    console.error(
      "[exerciseOverrideService:turso] Error fetching teacher overrides:",
      error
    );
    throw error;
  }
...
export async function getHiddenExercises(
  teacherEmail: string
): Promise<ExerciseOverride[]> {
  try {
    const result = await db.execute({
    ...
    console.error(
      "[exerciseOverrideService:turso] Error fetching hidden exercises:",
      error
    );
    throw error;
  }
...
export async function updateExerciseOverride(
  ...
  try {
    ...
    console.error(
      "[exerciseOverrideService:turso] Error updating override:",
      error
    );
    throw error;
  }
...
export async function updateDisplayOrders(
  ...
  try {
    ...
    console.error(
      "[exerciseOverrideService:turso] Error updating display orders:",
      error
    );
    throw error;
  }
...
export async function bulkUpdateDisplayOrder(
  ...
  try {
    ...
    const statements = orderUpdates.map(
      ({
        overrideId,
        displayOrder,
        exerciseId,
    ...
    console.error(
      "[exerciseOverrideService:turso] Error bulk updating orders:",
      error
    );
    throw error;
  }
...
export async function deleteExerciseOverride(
  ...
  try {
    ...
    console.error(
      "[exerciseOverrideService:turso] Error deleting override:",
      error
    );
    throw error;
  }
...
export async function deleteTeacherOverrides(
  teacherEmail: string
): Promise<void> {
  try {
    await db.execute({
    ...
    console.error(
      "[exerciseOverrideService:turso] Error deleting teacher overrides:",
      error
    );
    throw error;
  }
