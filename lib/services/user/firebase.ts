/**
 * User Service - Firebase Implementation
 * Database abstraction layer for user operations using Firestore
 *
 * This is the Firebase-compatible version of userService.
 * All user-related database operations use Firestore syntax.
 */
