...
export const a2Redemittel: Redemittel[] = [
  ...
  // ============================================
  {
    ...
    level: "A2",
    example: "Liebe Anna,",
    exampleTranslation: "Dear Anna,",
    tags: ["letter", "informal", "opening"],
  },
  {
    id: "a2-letter-2",
    german: "Lieber...",
    ...
    context: "letter",
    level: "A2",
    example: "Lieber Markus,",
    exampleTranslation: "Dear Markus,",
    tags: ["letter", "informal", "opening"],
  },
  {
    id: "a2-letter-3",
    ...
    exampleTranslation: "Hello Thomas,",
    tags: ["letter", "informal", "opening"],
  },
  {
    id: "a2-letter-4",
    german: "Viele Grüße",
    english: "Many greetings / Best regards",
    context: "letter",
    level: "A2",
    tags: ["letter", "informal", "closing"],
  },
  {
    id: "a2-letter-5",
    german: "Liebe Grüße",
  ...
  },
  {
    id: "a2-greet-5",
    german: "Freut mich!",
    english: "Pleased to meet you! (Short form)",
    context: "greetings",
    level: "A2",
    tags: ["polite", "short"],
  },
