...
import { getExerciseById } from "@/lib/data/creativeExercises";
...
export default function CreativeExercisePage() {
  ...
  const submissionHandlers = useWritingSubmissionHandlers({
    ...
    selectedCreative: exercise ?? null,
    selectedEmail: null,
    selectedLetter: null,
    writingText,
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Creative exercise not found.</p>
          <button
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <DashboardHeader
        ...
        subtitle={`${CEFRLevelInfo[exercise.level].displayName} \u2022 ${exercise.difficulty} \u2022 ${exercise.type}`}
        backButton={{
